<?php
	if(isset($_GET['id'])){
		...
		$conexao = db_conectar();
		define ("DOMINIO", "http://www.rfcasaecia.com.br");
		...
		$headers .= "From: RF Casa e Cia <contato@rfcasaecia.com.br>\r\n";
	...
	<body style='font-family: Century Gothic !important;width: 1100px;margin: auto;'>
		...
		$opts = array(
			...
			'assunto' => 'Orçamentos',
			'remetente' => 'contato@rfcasaecia.com.br',
			'nomeRemetente' => 'RF Casa e Cia',
			'destino' => array('Cliente' => $email, 'RF Casa e Cia' => 'rfcasaecia@hotmail.com'),
			'corpo' => $msg
